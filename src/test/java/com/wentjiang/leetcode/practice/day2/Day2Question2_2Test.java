...
class Day2Question2_2Test {
    ...
    private final Day2Question2_2 day2Question2_2 = new Day2Question2_2();

    @Test
    public void case1() {
        int[] forbidden = new int[] { 14, 4, 18, 1, 15 };
        int result = day2Question2_2.minimumJumps(forbidden, 3, 15, 9);
    ...
    public void case3() {
        ...
        int result = day2Question2_2.minimumJumps(forbidden, 16, 9, 7);
    ...
    public void case4() {
        ...
        int result = day2Question2_2.minimumJumps(forbidden, 29, 98, 80);
