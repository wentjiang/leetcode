...
class Question82Test {
    ...
    void deleteDuplicates() {
        Assertions.assertArrayEquals(new int[] { 1, 2, 5 }, ListNodeUtil.createArrayByListNode(
    ...
    void deleteDuplicates1() {
        Assertions.assertArrayEquals(new int[] { 2, 3 }, ListNodeUtil.createArrayByListNode(
