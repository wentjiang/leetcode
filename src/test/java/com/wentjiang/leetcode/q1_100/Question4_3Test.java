...
public class Question4_3Test {
    private final Question4_3 question4_3 = new Question4_3();

    @ParameterizedTest
    @MethodSource("generator")
    public void testFindMedianSortedArrays(Triplet<int[], int[], Double> triplet) {
        Assertions.assertEquals(triplet.getValue2(),
                question4_3.findMedianSortedArrays(triplet.getValue0(), triplet.getValue1()));
    }
